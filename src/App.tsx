  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      ...
      <div className="w-[400px]">
        ...
        <div className="bg-bg-primary rounded-sm shadow-sm py-4xl px-5xl flex flex-col items-center border border-border-primary">

          {/* Header */}
          <div className="flex flex-col w-full items-center text-center mb-4xl">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-xl">
            ...
            <Button
              type="submit"
              className="w-full justify-center mt-3xl"
              size="md"
              isLoading={isLoading}
            >
              로그인
          ...
          {/* Footer Links */}
          <div className="flex flex-col items-center w-full mt-3xl gap-lg">
